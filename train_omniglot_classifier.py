...
for real_batch_rate in (generated_batches_per_real + 1,):
    print(
    ...
    for bootstrap_sample in range(num_bootstrap_samples):
        ...
        for epoch in range(num_epochs):
            ...
            if epoch % progress_frequency == 0:
                ...
                #compute_val_accuracy(val_dataloader[0], classifier, device, loss_function)
                #print()
                #compute_val_accuracy(val_dataloader[1], classifier, device, loss_function)
