...
def get_cifar10(transform=[transforms.ToTensor()]*2, val_test_split=None, download=False):

    try:
        train = CIFAR10("backdoors/datasets/data", train=True,
                        transform=transform[0], download=download)
        val_test = CIFAR10("backdoors/datasets/data", train=False,
    ...
    return [train, val_test, val_test]
